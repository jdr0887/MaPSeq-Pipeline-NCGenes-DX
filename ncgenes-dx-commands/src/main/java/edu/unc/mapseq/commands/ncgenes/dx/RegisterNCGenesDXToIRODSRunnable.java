...
public class RegisterNCGenesDXToIRODSRunnable implements Runnable {

    private final Logger logger = LoggerFactory.getLogger(RegisterNCGenesDXToIRODSRunnable.class);
