...
import edu.unc.mapseq.pipeline.ncgenes.dx.NCGenesDXPipelineBeanService;
...
public class Activator implements BundleActivator {
    ...
    public void start(BundleContext context) throws Exception {
        ...
        NCGenesDXPipelineBeanService pipelineBeanService = null;
        ...
        if (references != null) {
            for (ServiceReference ref : references) {
                ...
                if (o instanceof NCGenesDXPipelineBeanService) {
                    pipelineBeanService = (NCGenesDXPipelineBeanService) o;
                    break;
                }
            }
        }
        ...
        if (pipelineBeanService != null) {
            ...
            this.destination = this.session.createQueue("queue/ncgenes.dx");
